...
IntegrationRS::createBaseIblockProperties($IBLOCK_ID);//Создаем базовые свойства. Делаем только при первой интеграции с сайтом. В остальные разы закомментируем
