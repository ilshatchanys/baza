...
IntegrationRS::getDataFromProdatFTP('/sklad/TVER/');

CEventLog::Add(array("SEVERITY" => "DEBUG","AUDIT_TYPE_ID" => "PRODAT_READT","MODULE_ID" => "main","ITEM_ID" => "","DESCRIPTION" => "Загружен файл PRODAT!"));
