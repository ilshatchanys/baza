...
IntegrationRS::getDataFromPricatFTP($_SERVER["DOCUMENT_ROOT"]);

CEventLog::Add(array("SEVERITY" => "DEBUG","AUDIT_TYPE_ID" => "PRICAT_READY","MODULE_ID" => "main","ITEM_ID" => "","DESCRIPTION" => "Файл PRICAT готов"));
