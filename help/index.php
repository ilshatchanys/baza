...
$APPLICATION->SetPageProperty("title", "Оплата и доставка | Интернет-магазин электротехнической продукции  КС-ГРУПП");
$APPLICATION->SetPageProperty("description", "Оплата и доставка. В интернет-магазине КС-ГРУПП вы можете приобрести электрооборудование и электротехническую продукцию по выгодным ценам. Быстрая доставка, гарантия, широкий ассортимент.");
