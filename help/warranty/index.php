...
$APPLICATION->SetPageProperty("title", "Возврат и обмен товара | Интернет-магазин электротехнической продукции КС-ГРУПП");
$APPLICATION->SetPageProperty("description", "Возврат и обмен товара. В интернет-магазине КС-ГРУПП вы можете приобрести электрооборудование и электротехническую продукцию по выгодным ценам. Быстрая доставка, гарантия, широкий ассортимент.");
