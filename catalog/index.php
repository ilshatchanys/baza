...
$APPLICATION->SetPageProperty("title", "Каталог электротехнической продукции и электрооборудования в Москве по выгодной цене — интернет-магазин КС-ГРУПП");
$APPLICATION->SetPageProperty("keywords", "каталог, электротовары, электротовары, электрооборудование, заказать, купить, интернет-магазин, ks-electrica.ru");
$APPLICATION->SetPageProperty("description", "В интернет-магазине КС-ГРУПП вы можете приобрести электротехническую продукцию и электрооборудование по низкой цене. Доставка по Москве и всей России. Заказывайте на сайте или звоните 8 (495) 374-51-99.");
$APPLICATION->SetTitle("Каталог");?>
<?if($APPLICATION->GetCurPage() == '/catalog.html' && !isset($_REQUEST['q'])):?>
...
<?elseif($APPLICATION->GetCurPage() == '/catalog/compare.php'):?>
<?$APPLICATION->IncludeComponent(
	"bitrix:catalog", 
	"main", 
	array(
		...
		"IBLOCK_SERVICES_ID" => "48",
		"IBLOCK_TIZERS_ID" => "36",
		"IBLOCK_LINK_REVIEWS_ID" => "45",
		"STAFF_IBLOCK_ID" => "42",
		"VACANCY_IBLOCK_ID" => "28",
		"SHOW_QUANTITY" => "Y",
		"SHOW_MEASURE" => "Y",
		...
		"LANDING_IBLOCK_ID" => "55",
		"DETAIL_BLOCKS_TAB_ORDER" => "char,desc,video,stores,reviews,buy,payment,delivery,custom_tab",
		...
		"SEF_URL_TEMPLATES" => array(
			"sections" => "",
			"section" => "r-#SECTION_CODE#.html",
			"element" => "d-#ELEMENT_CODE#.html",
			"compare" => "compare.php?action=#ACTION_CODE#",
			"smart_filter" => "r-#SECTION_CODE#.html/filter/#SMART_FILTER_PATH#/apply/",
		),
