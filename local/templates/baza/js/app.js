    ...
    (() => {
        ...
        function catalogInit() {
            if (document.querySelector(".header-bottom__catalog-btn")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".header-bottom__catalog-btn")) document.documentElement.classList.toggle("catalog-open");
            }));
        }
        ...
        function itemsCompare() {
            if (document.querySelector(".compare")) document.querySelectorAll(".compare").forEach((btn => {
                btn.addEventListener("click", (() => {
                    btn.classList.toggle("compared");
                }));
            }));
        }
        itemsCompare();
