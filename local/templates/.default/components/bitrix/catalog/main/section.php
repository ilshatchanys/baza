...
//set seo meta cannonical data
$sectionPage = $APPLICATION->GetCurPage();
if($arParams['DETAIL_SET_CANONICAL_URL'] === 'Y') {
	$domain = "ks-electrica.ru";
	$canonicalUrl = str_replace('#SECTION_CODE#', $arResult['VARIABLES']['SECTION_CODE'], $arResult['URL_TEMPLATES']['section']);
	$APPLICATION->SetPageProperty('canonical', 'https://' . $domain . '/' . $canonicalUrl);
}
