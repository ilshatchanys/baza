...
$APPLICATION->SetPageProperty("title", "Акции | Интернет-магазин электротехнической продукции КС-ГРУПП");
$APPLICATION->SetPageProperty("description", "Ознакомьтесь с актуальными акциями интернет-магазина КС-ГРУПП");
